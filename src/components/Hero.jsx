...
import CompanyLogoss from "./CompanyLogoss.jsx";
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="container relative " ref={parallaxRef}>
          ...
          <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
            <div className="relative bg-n-8  rounded-[1rem]">
              ...
              >
                ...
                <ScrollParallax isAbsolutelyPositioned>
                    <Notification className="hidden absolute -right-[5.5rem] bottom-[11rem] w-[18rem]
                    xl:flex"
        ...
        <CompanyLogoss className="hidden relative z-10 mt-20  lg:block" />
      </div>
